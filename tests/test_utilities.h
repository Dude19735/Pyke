...
#include "../src/objects/Vk_Structures.h"

namespace UT {
	namespace TestUtilities {
		typedef VK4::Vk_Vertex_PC TypeV;
		typedef VK4::Vk_Vertex_PCN TypeC;
		typedef VK4::Vk_Vertex_PCNT TypeN;
		typedef VK4::point_type TypeP;
		...
		std::string formatTimeOutput(const std::string& comment, const _Types&... _args) {
			std::string separator = VK4::GlobalCasters::castHighlightCyan("=================================================================================");
			std::string content = VK4::GlobalCasters::castCyan(std::format(comment, _args...));
